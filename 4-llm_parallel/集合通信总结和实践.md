...
<center>
<img src="../images/mpi4py/a0_broadcast.png" width="70%" alt="broadcast">
</center>
...
<center>
<img src="../images/mpi4py/a0_reduce_allreduce.png" width="80%" alt="ffn_structrue">
</center>
...
<center>
<img src="../images/mpi4py/a0_gather_allgather.png" width="80%" alt="ffn_structrue">
</center>
...
<center>
<img src="../images/mpi4py/a0_scatter_reducescatter.png" width="80%" alt="ffn_structrue">
</center>
...
<center>
<img src="../images/mpi4py/a0_reduce_scatter.gif" width="70%" alt="broadcast">
</center>

下面的动画显示了 `AllGather` 步骤，其中，在最后，每个 GPU 都会获取 AllReduce 作的完整结果。

<center>
<img src="../images/mpi4py/a0_all_gather.gif" width="70%" alt="broadcast">
</center>
