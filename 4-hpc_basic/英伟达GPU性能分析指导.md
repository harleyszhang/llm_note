...
<div align="center">
<img src="../images/gpu_perf/simple-gpu-arch.svg" width="60%" alt="simple-gpu-arch">
</div>
图1. GPU 架构的简化视图
...
即该线性层（矩阵乘法）的算术强度为 $315$，大于 V100 PCle 的 $124.4/40$。因此，在 V100 PCle 上，**该矩阵乘法受到算术限制，即 GPU 将被充分利用**。
